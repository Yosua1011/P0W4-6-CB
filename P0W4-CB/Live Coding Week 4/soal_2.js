...
Seorang pejudi memiliki kredit balance di Slot Machine sebanyak 5000 DOLLARS melakukan pemutaran Slot Machine. 
Slot machine adalah sebuah
...
function evaluateSlotMachine(Arr) {
    ...
    //Conditional
    if(hasil.length===3) {
        var hilang = Arr.reduce(function(a,b){return a+b}) * 50;
        var sisa = creditBalance-hilang;
        return 'YOU LOSE ' + hilang + ' DOLLARS, YOUR TOTAL CREDIT BALANCE IS ' + sisa + ' DOLLAR'
    } else if (hasil.length===2) {
        var profit = Arr.reduce(function(a,b){return a+b}) * 100;
        var akhir = creditBalance+profit;
        return 'YOU WIN ' + profit + ' DOLLARS, YOUR TOTAL CREDIT BALANCE IS ' +  akhir + ' DOLLAR'
    } else if (hasil.length===1) {
        var profit = Arr.reduce(function(a,b){return a+b}) * 200;
        var akhir = creditBalance+profit;
        return 'YOU WIN ' + profit + ' DOLLARS, YOUR TOTAL CREDIT BALANCE IS ' +  akhir + ' DOLLAR'
    }
  // CODING DISINI!
